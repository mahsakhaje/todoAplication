...
public class TimePickerFragment extends DialogFragment {
    ...
    public static TimePickerFragment newInstance(TaskTodo taskTodo) {

        Bundle args = new Bundle();
        args.putSerializable(DialogAddTask.SENDED_TASK, taskTodo);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        taskTodo = (TaskTodo) getArguments().getSerializable(DialogAddTask.SENDED_TASK);
